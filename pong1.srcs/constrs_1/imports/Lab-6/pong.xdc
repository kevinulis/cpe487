...
set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS33} [get_ports {speed[8]}]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports {speed[9]}]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {speed[10]}]
