...
ARCHITECTURE Behavioral OF tone IS
	...
	SIGNAL dataTri : signed (15 DOWNTO 0);
	SIGNAL dataSq : signed (15 DOWNTO 0);
BEGIN
	...
	WITH quad SELECT
	dataTri <= index WHEN "00", -- 1st quadrant
	        16383 - index WHEN "01", -- 2nd quadrant
	        0 - index WHEN "10", -- 3rd quadrant
	        index - 16383 WHEN OTHERS; -- 4th quadrant
	WITH quad SELECT
	dataSq <= index WHEN "00", -- 1st quadrant
	        index WHEN "01", -- 2nd quadrant
	        0-index WHEN "10", -- 3rd quadrant
	        0-index WHEN OTHERS; -- 4th quadrant
	        
	data <= dataSq WHEN btnu = '1' ELSE -- when button is pressed, square wave
	     dataTri; -- when button is not pressed, triangle wave
END Behavioral;
